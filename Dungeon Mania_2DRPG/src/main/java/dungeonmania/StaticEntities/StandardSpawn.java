...
public class StandardSpawn implements SpawnStrategy{
    /**
     * Strategy interface for spawning zombies on peaceful or standard difficulty. Used in ZombieToastSpawner.
