...
int main(void)
{
    ...
    {///////////////////////////////////////////////////////////////////
	 // -------->>>>>>>>        EXTRA TEST           <<<<<<<<-------- //
	 // if all of these three transport type if false                 //
	 // player should stay at current location                        //
	 ///////////////////////////////////////////////////////////////////
		printf("==================================\n");
		printf("========== All of 3 transport type is false"
